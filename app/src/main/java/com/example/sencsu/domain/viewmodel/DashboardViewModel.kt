...
import com.example.sencsu.domain.sync.SyncResult
...
class DashboardViewModel @Inject constructor(
    ...
    private val _lastSyncResult = MutableSharedFlow<SyncResult>(
        replay = 0,
        extraBufferCapacity = 1,
        onBufferOverflow = kotlinx.coroutines.channels.BufferOverflow.DROP_OLDEST
    )
    val lastSyncResult: SharedFlow<SyncResult> = _lastSyncResult.asSharedFlow()
    ...
    fun syncData() {
        viewModelScope.launch {
            ...
            _lastSyncResult.tryEmit(result)
    ...
    fun fetchDashboardData(agentId: String) {
        viewModelScope.launch {
